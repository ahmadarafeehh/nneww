...
class CommentCard extends StatefulWidget {
  ...
  final bool forcedTransparent; // Add this new parameter
  ...
  const CommentCard({
    ...
    this.likeCount = 0,
    this.onLikeChanged,
    this.forcedTransparent = false, // Default to false
  });
  @override
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Show character counter only when comment reaches 250 characters
