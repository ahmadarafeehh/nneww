...
class _PostCardState extends State<PostCard>
  ...
  void _initializeVideoPlayer() async {
    ...
    try {
      ...
      await _videoController!.initialize().timeout(
        ...
        onTimeout: () {
          throw Exception('loading for too long contact support');
        },
      );
  ...
  // Fetch initial ratings - same logic as ImageViewScreen
  ...
  // Rating submission handler - exact same as ImageViewScreen
  ...
  // Build video player with prominent circular loading indicator
  ...
  Widget _buildBottomOverlay(model.AppUser user, _ColorSet colors) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Use the same RatingBar widget with updated props - exactly like ImageViewScreen
          RatingBar(
