      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: colors.avatarBackgroundColor.withOpacity(0.6),
          ),
        ),
        ...
        Row(
          ...
          children: [
            Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: colors.buttonBackgroundColor.withOpacity(0.6),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          width: 30,
          decoration: BoxDecoration(
            color: colors.avatarBackgroundColor.withOpacity(0.8),
    ...
    return FutureBuilder<List<dynamic>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return _buildOtherPostsGridSkeleton(colors);
        }
